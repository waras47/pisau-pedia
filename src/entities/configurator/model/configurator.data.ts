...
export const shapes: KnifeShape[] = [
  { id: "gyuto", name: "Gyuto", category: "Multi-Purpose", image: "/images/configurator/shape-gyuto.webp", previewImage: "/images/configurator/preview-outline.png", silhouetteLight: "http://localhost:9000/pisaupedia/configurator/shapes/gyuto-black.png", silhouetteDark: "http://localhost:9000/pisaupedia/configurator/shapes/gyuto-grey.png" },
  { id: "santoku", name: "Santoku", category: "Multi-Purpose", image: "/images/configurator/shape-santoku.webp", previewImage: "/images/configurator/preview-outline.png", silhouetteLight: "http://localhost:9000/pisaupedia/configurator/shapes/santoku-black.png", silhouetteDark: "http://localhost:9000/pisaupedia/configurator/shapes/santoku-grey.png" },
  { id: "bunka", name: "Bunka", category: "Multi-Purpose", image: "/images/configurator/shape-bunka.webp", previewImage: "/images/configurator/preview-outline.png", silhouetteLight: "http://localhost:9000/pisaupedia/configurator/shapes/bunka-black.png", silhouetteDark: "http://localhost:9000/pisaupedia/configurator/shapes/bunka-grey.png" },
];
...
export const blades: KnifeBlade[] = [
  {
    id: "aoi-gyuto-210",
    image: "/images/configurator/blade-gyuto-1.jpg",
    shapeId: "gyuto",
    ...
    price: 248,
    compareAtPrice: 310,
    previewImage: "/images/configurator/preview-blade-gyuto-hap40.png",
  ...
  {
    id: "yama-gyuto-240",
    image: "/images/configurator/blade-gyuto-2.jpg",
    shapeId: "gyuto",
    name: "Yama Gyuto 240mm",
    steel: "VG-10",
    lengthMm: 240,
    price: 296,
    previewImage: "/images/configurator/preview-blade-gyuto-suj2.png",
  ...
  {
    id: "sumi-santoku-180",
    image: "/images/configurator/blade-santoku-1.jpg",
    shapeId: "santoku",
    name: "Sumi Santoku 180mm",
    steel: "Aogami #2",
    lengthMm: 180,
    price: 162,
    previewImage: "/images/configurator/preview-blade-santoku-zdp.png",
  ...
  },
  {
    ...
    image: "/images/configurator/blade-santoku-2.jpg",
    shapeId: "santoku",
  ...
  {
    id: "kuro-bunka-190",
    image: "/images/configurator/bunka1.webp",
    shapeId: "bunka",
    ...
    price: 176,
    compareAtPrice: 220,
    previewImage: "/images/configurator/preview-blade-bunka-hap40.png",
  ...
  {
    id: "hap40-bunka-190",
    image: "/images/configurator/bunka2.webp",
    shapeId: "bunka",
    ...
    price: 228,
    compareAtPrice: 285,
    previewImage: "/images/configurator/preview-blade-bunka-zdp-silver.png",
...
export const handles: KnifeHandle[] = [
  { id: "magnolia", name: "Magnolia", material: "Magnolia wood", priceDelta: 0, image: "/images/configurator/handle-magnolia-single.jpg", previewImage: "/images/configurator/preview-handle-magnolia.png", previewColor: "#E4D9BE" },
  { id: "walnut", name: "Walnut", material: "Walnut wood", priceDelta: 20, image: "/images/configurator/handle-walnut-single.jpg", previewImage: "/images/configurator/preview-handle-kyoto.png", previewColor: "#6B4A35" },
  { id: "horn", name: "Buffalo Horn", material: "Magnolia + horn", priceDelta: 35, image: "/images/configurator/handle-horn-single.jpg", previewImage: "/images/configurator/preview-handle-rosewood.png", previewColor: "#2B2A28" },
  { id: "ebony", name: "Ebony", material: "Ebony + horn", priceDelta: 45, image: "/images/configurator/handle-ebony-single.jpg", previewImage: "/images/configurator/preview-handle-ebony.png", previewColor: "#1C1712" },
];

// Langkah 4 — accessories (opsional, bisa pilih lebih dari satu)
export const accessories: KnifeAccessory[] = [
  { id: "saya", name: "Magnolia Saya (sheath)", price: 24, image: "/images/products/wooden-saya-gyuto-210.jpg" },
  { id: "engraving", name: "Custom Engraving", price: 15, image: "/images/products/custom-engraving.jpg" },
  { id: "board", name: "Ginko Cutting Board", price: 58, image: "/images/products/ginko-cutting-board-s.jpg" },
];
