...
export const engravings: Product[] = [
  {
    id: "eng-1",
    ...
    reviewCount: 30,
    description:
      "Your own text, initials, or custom design engraved onto any knife blade. We send a digital preview for your approval before engraving. Turnaround: 2 business days after approval.",
    highlights: [
      "Any text, initials, or custom artwork",
      "Digital preview sent for approval",
      "2 business days after confirmation",
      "Best results on smooth, polished blades",
    ],
    specs: [
      { label: "Method", value: "Precision laser engraving" },
      { label: "Turnaround", value: "2 business days" },
      { label: "Preview", value: "Digital mockup included" },
      { label: "Returns", value: "Not eligible (custom item)" },
    ],
  },
  {
    id: "eng-2",
