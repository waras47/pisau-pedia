  ...
  async function handleSave() {
    ...
    try {
      ...
      const payload = {
        ...
        starts_at: editCoupon.startDate ? `${editCoupon.startDate}T00:00:00Z` : undefined,
        ends_at: editCoupon.endDate ? `${editCoupon.endDate}T23:59:59Z` : undefined,
  ...
  async function toggleStatus(coupon: Coupon) {
    ...
    try {
      await updateCoupon(coupon.id, {
        ...
        starts_at: coupon.startDate ? `${coupon.startDate}T00:00:00Z` : undefined,
        ends_at: coupon.endDate ? `${coupon.endDate}T23:59:59Z` : undefined,
